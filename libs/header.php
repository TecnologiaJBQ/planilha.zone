...
<script>
  ...
  ga('create', 'UA-51158860-2', 'planilha.zone');
  ga('send', 'pageview');
</script>
...
<body>
    ...
    <div class="col-sm-6 control-label">
        <h1><a href="/">PLANILHA.ZONE</a></h1>
    </div>
    <div class="col-sm-6">

            <span class="en help-block">
                A planilha da transportadora que você precisa<br />no formato que você precisa.
            </span>
